...
const Button = ({ onClick, children, variant = "primary", className = "", size = "md", disabled = false, type = "button" }) => {
  const base = "font-bold transition-all duration-250 flex items-center justify-center gap-2 active:scale-95";
  ...
  const variants = {
    ...
    outline: "border-2 border-[#FFA400] text-[#FFA400] bg-transparent hover:bg-[#FFA400] hover:text-white",
